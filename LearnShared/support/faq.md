...
## <a name="what-is-microsoft-learn"></a>Apa itu Microsoft Learn?
...
## <a name="how-much-does-it-cost"></a>Berapa harganya?
...
## <a name="what-content-is-available-on-microsoft-learn"></a>Konten apa yang tersedia di Microsoft Learn?
...
## <a name="do-i-need-to-create-a-profile-to-use-microsoft-learn"></a>Apakah saya perlu membuat profil untuk menggunakan Microsoft Learn?

Tidak, Anda tidak perlu membuat profil. Tanpa profil, Anda tetap dapat mengakses dan menggunakan semua konten pembelajaran.

## <a name="which-features-become-available-to-me-when-i-sign-in"></a>Fitur apa saja yang tersedia saat saya masuk?
...
## <a name="what-is-a-learning-path"></a>Apa itu jalur pembelajaran?
...
## <a name="what-is-a-module"></a>Apa itu modul?
...
## <a name="what-is-a-unit"></a>Apa itu unit?
...
## <a name="what-is-a-collection"></a>Apa itu koleksi?
...
## <a name="what-are-badges"></a>Apa itu lencana?
...
## <a name="what-are-trophies"></a>Apa itu piala?
...
## <a name="how-do-i-edit-my-profile"></a>Bagaimana cara mengedit profil saya?
...
## <a name="how-do-i-delete-my-user-data"></a>Bagaimana cara menghapus data pengguna saya?

Anda dapat menghapus semua data pengguna Microsoft Docs di halaman [Edit Profil Anda](https://techprofile.microsoft.com/edit).

## <a name="how-do-i-change-my-password"></a>Bagaimana cara mengubah kata sandi?
...
## <a name="what-is-the-microsoft-learn-sandbox"></a>Apa itu kotak pasir Microsoft Learn?
...
## <a name="why-do-i-need-a-sandbox"></a>Mengapa saya memerlukan kotak pasir?
...
## <a name="how-do-i-activate-the-sandbox"></a>Bagaimana cara mengaktifkan kotak pasir?
...
![Pemberitahuan “Kini Anda dapat mengakses kotak pasir”](./media/sandboxfaq3.png)

## <a name="how-long-does-activation-take"></a>Berapa lama waktu yang diperlukan untuk proses aktivasi?
...
## <a name="what-happens-when-i-activate-a-sandbox"></a>Apa yang terjadi ketika saya mengaktifkan kotak pasir?
...
## <a name="how-do-i-sign-in-to-the-sandbox-when-i-use-the-azure-portal"></a>Bagaimana cara masuk ke kotak pasir saat saya menggunakan portal Azure?
...
## <a name="how-can-i-tell-if-im-in-the-sandbox-when-i-use-the-azure-portal"></a>Bagaimana cara mengetahui apakah saya berada di kotak pasir saat menggunakan portal Azure?
...
!["Microsoft Learn Sandbox" ditampilkan di sudut kanan atas di bawah nama Anda](./media/sandboxfaq5.png)

## <a name="what-if-im-not-in-the-right-subscription"></a>Bagaimana jika saya tidak berada dalam langganan yang tepat?
...
## <a name="im-seeing-resource-groups-named-sandbox-resource-group-in-the-instructions-what-does-that-mean"></a>Saya melihat grup sumber daya bernama [Grup sumber daya kotak pasir] dalam instruksi. Apa maksudnya?
...
## <a name="how-long-does-the-sandbox-stay-around"></a>Berapa lama kotak pasir akan bertahan?
...
## <a name="what-happens-when-the-sandbox-times-out"></a>Apa yang terjadi jika waktu akses kotak pasir habis?
...
## <a name="can-i-use-the-sandbox-from-visual-studio-vs-code-or-my-favorite-azure-tool"></a>Dapatkah saya menggunakan kotak pasir dari Visual Studio, VS Code, atau alat Azure favorit saya?
...
## <a name="what-are-the-limitations-of-the-sandbox-environment"></a>Apa saja batasan lingkungan kotak pasir?
...
## <a name="does-resetting-azure-cloud-shell-reset-the-sandbox-too"></a>Apakah mengatur ulang Azure Cloud Shell juga mengatur ulang kotak pasir?
